...
export function SignupView() {
  ...
  function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    setMessage("계정 생성 API 연결 전 데모 화면입니다.");
  }

  return (
    <main className="auth-page signup-page">
      <section className="brand-panel" aria-label="마음이음 소개">
        <a className="brand brand-on-dark" href="/" aria-label="마음이음 홈"><span className="brand-symbol" aria-hidden="true"><i /><b /></span><span>마음이음</span></a>
      ...
      <section className="form-panel">
        <div className="mobile-brand"><a className="brand" href="/" aria-label="마음이음 홈"><span className="brand-symbol" aria-hidden="true"><i /><b /></span><span>마음이음</span></a></div>
        <div className="auth-card signup-card">
          <div className="auth-heading"><span className="eyebrow blue">부모 계정</span><h2>회원가입</h2><p>아이 프로필은 가입 후 연결할 수 있어요.</p></div>
          <form onSubmit={handleSubmit} noValidate>
            ...
            <button className="primary-button signup-button" type="submit">계정 만들기</button>
